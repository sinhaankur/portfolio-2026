...
export const moons: MoonData[] = [
  ...
  { name: "Triton", textureUrl: "/textures/triton.webp",          parent: "Neptune", visualRadius: 0.055, orbitRadius: 0.95, periodDays: -5.88,  shade: "#d8c6b8", fact: "Neptune's largest moon. Orbits BACKWARDS (retrograde) — likely a captured Kuiper Belt object." },
