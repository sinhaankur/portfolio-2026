...
import { useSliderNavigation, useSliderDrag, useSliderWheel, useColorExtraction, useCurrentColors } from "./hooks"

export function ArtGallerySlider() {
  const sliderRef = useRef<HTMLDivElement>(null)

  // Track viewport width client-side to avoid referencing `window` during SSR
    ...
    <div className="relative h-full w-full overflow-hidden">
      ...
      >
        <motion.div
          ...
          animate={{
            x: -currentIndex * (isDesktop ? 564 : 432) + dragX,
          }}
