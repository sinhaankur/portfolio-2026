...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: { path: string; priority: number; changeFrequency: "monthly" | "weekly" }[] = [
    ...
    { path: "/lab/celestial",     priority: 0.8, changeFrequency: "monthly" },
    { path: "/lab/terrain",       priority: 0.8, changeFrequency: "monthly" },
    { path: "/reference/spacecraft", priority: 0.7, changeFrequency: "monthly" },
    { path: "/reference/satellites", priority: 0.7, changeFrequency: "weekly" },
    ...
    { path: "/lab/optical-flow",  priority: 0.7, changeFrequency: "monthly" },
        { path: "/lab/math",          priority: 0.8, changeFrequency: "monthly" },
{ path: "/lab/pi",            priority: 0.7, changeFrequency: "monthly" },
    { path: "/lab/euler",         priority: 0.7, changeFrequency: "monthly" },
    { path: "/lab/fourier",       priority: 0.7, changeFrequency: "monthly" },
    ...
    { path: "/ko",                priority: 0.6, changeFrequency: "monthly" },
    { path: "/zh",                priority: 0.6, changeFrequency: "monthly" },
    { path: "/es",                priority: 0.6, changeFrequency: "monthly" },
