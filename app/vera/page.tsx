...
export const metadata: Metadata = {
  ...canonicalPath("/vera"),
  title: "Vera — my mother, and the twin built to keep her warmth close",
  description:
    "A page for my mother — the person the Cognitive Twin (Vera) was built for: a local-first, on-device way to keep a loved one's voice, warmth, and character close.",
  keywords: ["Vera", "cognitive twin", "memory", "on-device voice"],
}
    ...
    <main className="mx-auto max-w-3xl px-6 md:px-12 py-20 md:py-28">
      ...
      <article>
        ...
        <p className="font-sans text-base md:text-lg text-foreground/70 leading-relaxed mb-4">
          ...
          <Link href="/lab/cognitive-twin" className="text-accent hover:underline">the Cognitive Twin</Link>. Some
          people you carry with you. This is my way of keeping her warmth close.
        </p>

        <H2>Her page</H2>
        <P>
          {/* Her name, her story, and her life go here — written by Ankur. */}
          Her story belongs here, in her own words and mine — who she was, what she loved, the way she
          shaped the people around her. This page is hers to hold.
        </P>
